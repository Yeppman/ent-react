...
class PostDetail extends React.Component{
    ...
    Get_Vendor_Profile = async(Vendor_id) =>{
      ...
      await axios.get(`https://back-ent.herokuapp.com/core_api/vendors_profile_public/${Vendor_id}/`)
      .then(res =>{
        this.setState({
    ...
    Get_reverse_url_id = async() => {
        ...
        await axios.get(`https://back-ent.herokuapp.com/core_api/post_detail/${model_id}/`)
        .then(res =>{
            this.setState({
