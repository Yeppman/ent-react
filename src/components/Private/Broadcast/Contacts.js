...
class Contact_Field extends Component{
    ...
    Contact_List  = async(token) =>{
        ...
        await axios.get('https://back-ent.herokuapp.com/management/contact_list/')
        .then(res =>{
            this.setState({
                contacts : res.data,
                loading : false
    ...
    delete_contact = async (id) =>{
      axios.defaults.headers = {
        ...
        await axios.get(`https://back-ent.herokuapp.com/management/delete_contact/${id}/`)
        .then(res =>{
      ...
      Mail_Clients = (values,err) =>{
        ...
        console.log(Email, Phone)
         ...
         axios.defaults.xsrfCookieName = "csrftoken";
             ...
             axios.get(`https://back-ent.herokuapp.com/management/broadcast/`,
              {
               params: {
    ...
    process_query = (values,err) =>{
         ...
         const Name =  
          ...
          axios.defaults.xsrfCookieName = "csrftoken";
              ...
              axios.get(`https://back-ent.herokuapp.com/management/save_contact/`,
               {
                params: {
