...
const Profile_id_url  = 'back-ent.herokuapp.com/stream/get_profile_id/'
const Profile_url = 'back-ent.herokuapp.com/stream/profile_view/'

const Business_Profile_id_url = "back-ent.herokuapp.com/stream/get_business_profile_id/"
const Business_Profile_url = 'back-ent.herokuapp.com/stream/business_profile/'

const My_User_id_url = "back-ent.herokuapp.com/stream/get_my_user_id/"
...
class User_Profile extends React.Component{
    ...
    Profile_detail = (token,parse_user_id) =>{
        axios.defaults.headers = {
          ...
          axios.get(`back-ent.herokuapp.com/stream/profile_view/${parse_user_id}/`)
          .then(res =>{
            this.setState({
              profile: res.data
            })
