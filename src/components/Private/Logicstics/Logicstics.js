...
class Logicstics_Channel extends Component{
     ...
     Get_All_logicstics = (token) =>{
          ...
          axios.get('http://back-ent.herokuapp.com/management/view_logicstics/')
          .then(res =>{
               this.setState({
                    channels : res.data
     ...
     Order_Counts = async(token)=>{
          ...
          await axios.get(`http://back-ent.herokuapp.com/management/order_counter/`)
          .then(res =>{
               this.setState({
     ...
     delete_order = async(order_id)=>{
          ...
          await axios.post(`http://back-ent.herokuapp.com/management/delete_logicstics/${order_id}/`)
          .then(res =>{
