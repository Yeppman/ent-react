...
class Logicstics_Details extends React.Component{
    ...
    Get_Order_Contents = async(token) =>{
        ...
        axios.get(`https://back-ent.herokuapp.com/management/view_channel_content/${this.order_id}/`)
        .then(res =>{
           this.setState({
    ...
    Change_Delivery_Status = async(checked)=>{
      ...
      await axios.post(`https://back-ent.herokuapp.com/management/change_delivery_status/${this.order_id}/`)  
      .then(res =>{
    ...
    Delete_Order = async()=>{
      ...
      await axios.post(`https://back-ent.herokuapp.com/management/delete_logicstics/${this.order_id}/`)
      .then(res =>{
          openNotification(res.data['Message'])
      })
    }
    ...
    render(){
        ...
        const {order_contents, delivered,  created, date_delivered   } = this.state
