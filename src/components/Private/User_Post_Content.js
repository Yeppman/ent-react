...
const users_post_detail_url = 'http://back-ent.herokuapp.com/stream/view_post_contents/'
const user_delete_post_url = 'http://back-ent.herokuapp.com/stream/delete_post/'
...
class User_Post_Conent extends Component{
    ...
    Get_Comments = () =>{
      const model_id = this.model_id
       axios.get(`http://back-ent.herokuapp.com/core_api/comment_list/${model_id}/`)
      .then(res =>{
          this.setState({
    ...
    Ratings = async(token)=>{
      ...
      await axios.get(`http://back-ent.herokuapp.com/core_api/post_rating/${parse_id}/`)
      .then( res =>{
    ...
    Quotes =async (token) =>{
      ...
      await axios.get(`http://back-ent.herokuapp.com/stream/quotations/${parse_id}/`)
      .then( res =>{
        this.setState({
          quotes : res.data
        })
