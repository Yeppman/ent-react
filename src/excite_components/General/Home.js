...
const post_list_url = 'http://backend-entr.herokuapp.com/core_api/post_list/'
const latest = 'http://backend-entr.herokuapp.com/core_api/latest_uploads/'
class All_Uploads extends Component{
    state = {
      ...
      Categories =async()=>{
        const categories_url = 'http://backend-entr.herokuapp.com/core_api/category_list/'
