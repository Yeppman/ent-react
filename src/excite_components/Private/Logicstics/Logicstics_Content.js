...
class Logicstics_Details extends React.Component{
    ...
    Get_Order_Contents = async(token) =>{
        ...
        axios.get(`http://backend-entr.herokuapp.com/management/view_channel_content/${this.order_id}/`)
        .then(res =>{
           this.setState({
    ...
    Change_Delivery_Status = async(checked)=>{
      ...
      await axios.post(`http://backend-entr.herokuapp.com/management/change_delivery_status/${this.order_id}/`)  
      .then(res =>{
    ...
    Delete_Order = async()=>{
      ...
      await axios.post(`http://backend-entr.herokuapp.com/management/delete_logicstics/${this.order_id}/`)
      .then(res =>{
          openNotification(res.data['Message'])
      })
    }
